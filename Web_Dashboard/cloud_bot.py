...
.badge-live{display:inline-flex;align-items:center;gap:5px;background:#1e3a5f;color:#60a5fa;font-size:11px;padding:4px 10px;border-radius:20px;border:1px solid #2563eb}
...
<div class="header">
  ...
  <span class="badge-live">Research Phase</span>
</div>
...
<div id="tab-approach" class="tab-content active">
  ...
  <div class="card" style="border-left: 3px solid #3b82f6;">
    <div class="card-title" style="color:#f1f5f9;">Phase 3 — Stat arb BTC/ETH <span style="color:#60a5fa;">(In Research)</span></div>
    ...
    <div style="display:flex; flex-direction:column; gap:12px;">
      ...
      <div style="font-size:13px; color:#cbd5e1; line-height:1.6;">
        ...
        This strategy eliminates directional market risk (immune to sudden market-wide crashes) and capitalizes on perfect execution infrastructure: infinite liquidity and minimal spreads via Binance Futures.
      </div>
    </div>
  </div>
